...
| 4 — Production hardening | **In progress — Step 1 (telemetry) built, self-verified in a network-less sandbox, one real finding open.** See [`MILESTONE4_PROGRESS.md`](./MILESTONE4_PROGRESS.md). |
